...
INSERT INTO `project` (`id`, `name`, `create_time`, `update_time`) VALUES (NULL, 'test13', current_timestamp(), current_timestamp()), (NULL, 'test243', current_timestamp(), current_timestamp()), (NULL, 'test34324', current_timestamp(), current_timestamp());
